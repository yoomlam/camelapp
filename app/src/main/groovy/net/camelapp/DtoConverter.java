...
public class DtoConverter extends TypeConverterSupport {
    ...
    @Override
    public <T> T convertTo(Class<T> targetClass, Exchange exchange, Object value) throws TypeConversionException {
        try {
//            System.err.println("targetClass: " + targetClass + " value: " + value.getClass());
