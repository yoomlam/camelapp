...
// This works too:
//                    .process(exchange -> {
//                        String headerId=exchange.getMessage().getHeader("id", String.class);
...
//                    })
        ...
        rest("/claim")
                ...
                // POST
                .post("processA/").description("Process claim type A")
                .type(Claim.class)
                .outType(Payload.class)
                .to("direct:claimTypeA")

                // testing with GET
                .get("processA/").description("Trigger claim type A")
                .outType(Payload.class)
//                .to("direct:claimTypeA")
                .route()
